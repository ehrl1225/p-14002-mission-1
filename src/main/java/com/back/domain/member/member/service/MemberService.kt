...
class MemberService (
    ...
    fun join(username: String, password: String?, nickname: String, profileImgUrl: String? = null): Member {
        ...
        var password = if (password != null && !password.isBlank()) passwordEncoder!!.encode(password) else null

        val member = Member(username, password?:"", nickname, profileImgUrl?:"https://placehold.co/600x600?text=U_U")
